...
// ================================================
// Origin URL 관리 (Capacitor Android 지원)
// ================================================

// 올바른 origin URL 반환 (Capacitor 앱 환경 지원)
function getAppOrigin() {
    // Android 앱인 경우 capacitor.config의 androidScheme 사용
    ...
    // 그 외의 경우 window.location.origin 사용
...
async function signInWithGoogle(redirectUrl = null) {
    ...
    const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
            redirectTo: getAppOrigin() + `/${redirectUrl}`
        }
    });
